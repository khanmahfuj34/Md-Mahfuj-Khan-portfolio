    ...
    >
      ...
      <div className="relative mx-auto max-w-4xl px-4 sm:px-6 lg:px-8">
        ...
        <motion.div
          ...
          className="relative border-l-2 border-gray-200 pl-6 dark:border-gray-800 sm:pl-10"
        >
          {EDUCATION.map((edu, index) => (
            ...
            >
              ...
              {/* Card Surface */}
              <div className="group relative rounded-2xl border border-gray-200 bg-white p-6 shadow-xs backdrop-blur-md transition-all hover:border-blue-500/30 hover:shadow-md dark:border-gray-800/80 dark:bg-gray-950/40">
                ...
                <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-4">
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center space-x-1.5">
                      ...
                      <h3 className="font-display text-lg font-bold text-gray-950 dark:text-white group-hover:text-blue-600 dark:group-hover:text-blue-400 transition-colors">
                        {edu.degree}
                      </h3>
                    </div>
                    ...
                    {edu.description && (
                      <p className="mt-2 text-xs leading-relaxed text-gray-650 dark:text-gray-400">
                        {edu.description}
                      </p>
                    )}
                    ...
                    {edu.achievements && (
                      <div className="mt-3.5 space-y-1">
                        {edu.achievements.map((ach, aIdx) => (
                          <div key={aIdx} className="flex items-start space-x-2 text-xs text-gray-600 dark:text-gray-400">
